                    ...
                    <div class="form-group">
                      ...
                      <select name="market" id="market_id" class="form-control">
                        ...
                        <?php while ($data = $market_data->fetch_assoc()) { ?>
                          <option value="<?php echo $data['id'] ?>" <?php if ($data['id'] == $dataV['collected_by']) {
                                                                      echo 'selected';
                                                                    } ?>> <?php echo $data['name'] ?> ID: <?php echo $data['id'] ?> </option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
                      ...
                      <span id="deal">
                        <select name="dealer" id="" class="form-control">
                          <?php while ($data = $dealer_data->fetch_assoc()) { ?>
                            <option value="<?php echo $data['id'] ?>" <?php if ($data['id'] == $dataV['dealer_id']) {
                                                                        echo 'selected';
