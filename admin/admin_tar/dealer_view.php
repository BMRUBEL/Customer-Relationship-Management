...
<body class="hold-transition sidebar-mini">
                ...
                <div class="card-body">
                  <div class="container">
                    ...
                    <td><input type="text" name="password" value="<?php echo ($da['password']) ?>" class="form-control"></td>
                        ...
                        <tr>
                          <th>trade license</th>
                          <td><img src="./assets/dealer_img/<?php echo $data['trade_license'] ?>" width="100" height="100" alt=""></td>
                        </tr>
                        <tr>
                          <th>company name</th>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2023-2024 <a href="#">IsDB-BISEW</a>.</strong> All rights reserved.
  </footer>
  </div>
  <!-- ./wrapper -->
