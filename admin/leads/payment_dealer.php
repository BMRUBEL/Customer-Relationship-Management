    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Dealer Payment</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                  <h6 class="card-title">Payment Dealer</h6>
                  <form action="" method="post">
                    <table class="table table-bordered">
                      <tr>
                        <th>Dealer</th>
                        <td>
                          <select name="dealer_id" id="admin_s" class="form-control">
                            <option value="">Select dealer</option>
                            <?php while ($data = $result->fetch_assoc()) { //var_dump($data)
                            ?>
