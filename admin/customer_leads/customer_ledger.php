...
$qry = ("SELECT * FROM `customers` where dealer_id=" . $_SESSION['id']);
$result = $db->query($qry);
            ...
            <div class="col-lg-12">
              ...
              <div class="card card-primary card-outline">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Select A Marketing Manager </label>
                  <select name="" id="markng" class="form-control">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody id="dealer">
                        <?php while ($s = $result->fetch_assoc()) {
                          ...
                          //echo("<hr>");
                          //$mrkt_id=$s["id"];
                          //$pmt_data=$db->query("SELECT * from `payments` where `payments`.`collected_by`=$mrkt_id")->fetch_assoc(); 
                          //var_dump($pmt_data);
                        ?>
                          <tr>
